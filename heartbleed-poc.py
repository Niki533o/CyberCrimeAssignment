# This code is for the ISEC3004 demonstration of group 15. This is only configured for openSSL 1.0.0e versions.
# Only to be run on Ubuntu 13 servers with older SSL non upgraded versions. 
